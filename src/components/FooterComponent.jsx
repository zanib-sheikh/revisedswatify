      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start lg:space-x-16">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <button className="mt-2 font-semibold font-sans shadow-sm shadow-gray-400/50 bg-gradient-to-tr from-purple-950 to-pink-500 text-white py-2 px-4 rounded-full">
              Contact Swatify
            </button>
          </div>
        </div>
