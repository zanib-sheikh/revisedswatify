...
function Home() {
  return (
    ...
    ></div>
      ...
      <main className="text-center py-20  px-4">
        ...
        <h1 className="text-4xl font-space-grotesk font-semibold md:text-5xl py-6 leading-tight">
          AI Calling Agent That Handles <br />
          Calls and Sceduling<span className="text-pink-600"> – So You</span><br/>
 ...
 <div className="relative z-10 flex flex-col items-center justify-center">
  ...
  <div className="relative w-full md:w-auto mt-4 md:mt-0">
      <button className="bg-gradient-to-t from-purple-600 to-pink-500 px-4 py-2 rounded-full text-white w-full"> {/* Full width for mobile */}
        Call Me ➡
      </button>
    </div>
</div>
 ...
 <div className="w-full mt-16 md:mt-32 flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0 md:space-x-4 px-4 md:px-12">
          ...
          <div className="flex justify-start items-start mt-1 ml-4">
  <div
    className="bg-transparent rounded-full px-6 py-3 inline-flex items-center justify-start font-space-grotesk text-white"
    style={{
      border: 'transparent',
    ...
    What is Sawtify?
          ...
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 w-full md:w-[50%]">
            ...
            <button className="p-6 md:p-8 rounded-full border border-purple-600 bg-transparent shadow-inner shadow-pink-500/60 flex items-center justify-center w-16 h-16 md:w-20 md:h-20">
              <img src={mic} alt="mic" className="w-12 h-6 md:w-24 md:h-6" /></button>
  ...
  {/* voicr agent work 2*/}
<div class="w-full flex flex-col items-center justify-center mt-20 p-2">
...
<div className="relative grid grid-cols-1 sm:grid-cols-2 text-left gap-8 max-w-4xl mx-auto">
  ...
  <div className="absolute top-[calc(-1%+3rem)] w-[calc(23%+18px)] h-[20px] border-t border-dashed border-purple-500 transform translate-y-[-50%] right-60 sm:block hidden"></div>
  <div className="absolute top-[calc(4%+3rem)] h-[62px] border-l border-dashed border-purple-500 transform translate-y-[-50%] left-[calc(70%+2rem)] sm:block hidden"></div>
  ...
  <div className="absolute top-[calc(60%+6rem)] w-[calc(23%+18px)] h-[20px] border-t border-dashed border-purple-500 transform translate-y-[-50%] right-60 sm:block hidden"></div>
  <div className="absolute top-[calc(64%+6rem)] h-[58px] border-l border-dashed border-purple-500 transform translate-y-[-50%] left-[calc(70%+2rem)] sm:block hidden"></div>

  <div className="absolute top-[calc(18%+9rem)] w-[calc(26%+16px)] h-[18px] border-t border-dashed border-purple-500 transform translate-y-[-50%] left-[calc(20%+2rem)] sm:block hidden"></div>
  <div className="absolute top-[calc(17%+11rem)] h-[68px] border-l border-dashed border-purple-500 transform translate-y-[-50%] left-[calc(20%+2rem)] sm:block hidden"></div>
</div>
</div>
...
{/* sawtify simplifies your business 3*/}

<div className="flex w-full p-2 flex-col md:flex-row px-6 mt-6 md:mt-28 justify-between py-12 space-y-8 md:space-y-0 md:space-x-12">
...
{/* why choose sawtify*/}
<div className="flex flex-col md:flex-row justify-between px-8 py-10 space-y-8 md:space-y-0 md:space-x-12 mt-10">
  ...
  <div className="max-w-lg text-left">
    ...
    <button className="font-space-grotesk bg-gradient-to-r from-purple-700 to-pink-600 px-6 py-2 rounded-full text-white mt-4">
      Request a Demo ➡
    </button>
  </div>

<div className="w-full flex flex-col mt-20 items-start mx-auto p-0 md:ml-[-20%] py-2 text-left md:pr-20 md:w-2/3 space-y-4">

<div className="flex items-center space-x-4">
  <button className="p-4 rounded-full bg-gradient-to-r from-purple-700 to-pink-600 text-white w-12 h-12 flex items-center justify-center">
...
<div className="border-t-2 border-gray-500 border-dashed w-full my-4 last:hidden"></div>
</div>
</div>
...
<div className="w-full max-w-5xl mx-auto mt-10 md:mt-2 py-20 px-6 rounded-3xl bg-gradient-to-br from-purple-700 via-pink-400 to-orange-500 shadow-lg text-white">
